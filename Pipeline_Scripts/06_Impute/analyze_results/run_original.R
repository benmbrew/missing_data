...
scripts_folder <- paste(project_folder, "Scripts", "06_Two_Thousand_Features_Clust", sep = "/")
...
similarityCols <- c("cancer", "seed", "similarity", "set", "acc",
                    ...
                    "intPval", "intCi", "runTime", "cluster_number")
...
# drop cluster_number
originalSimilarity$cluster_number <- NULL
...
write.csv(combinedScores, paste0(results_folder, '/scoresTwoThousandOrigClust.csv'))
