...
clusterCols <- c("cancer", "impute", "seed", "cluster", "set", "acc",
                 ...
                 "con_index_p", "bias_corrected_c_index", "intAcc", "intNmi", "intPval",
                 "intCi", "intse.std","intPvalcox", "intCoefcox", "intCon_index_ci",
                 "intCon_index_p", "intBias_corrected_c_index", "runTime")
...
similarityCols <- c("cancer", "impute", "set", "acc",
                    "nmi", "pval", "ci", "se.std","pvalcox", "coefcox", "con_index_ci",
                    "con_index_p", "bias_corrected_c_index", "intAcc", "intNmi", "intPval",
                    "intCi", "intse.std","intPvalcox", "intCoefcox", "intCon_index_ci",
                    "intCon_index_p", "intBias_corrected_c_index", "runTime")
...
write.csv(combinedScores, paste0(results_folder, '/scoresTwoThousandOrigIntDup.csv'))
