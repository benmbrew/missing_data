...
scripts_folder <- paste(project_folder, "Scripts", "06_Two_Thousand_Features_Dup_Clust", sep = "/")
...
write.csv(combinedScores, paste0(results_folder, '/scoresTwoThousandClustNew.csv'))
