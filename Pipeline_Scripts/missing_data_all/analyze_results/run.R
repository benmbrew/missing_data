...
write.csv(combinedScores, paste0(results_folder, '/missing_data_complete_all.csv'))
...
xGreaterY <- function(x, y) {
  t.test(x, y, alternative="greater", paired=FALSE, var.equal = FALSE, na.action = na.omit)$p.value < 0.05
}
