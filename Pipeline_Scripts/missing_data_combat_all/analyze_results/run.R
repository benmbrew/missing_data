...
scripts_folder <- paste(project_folder, "Scripts", "missing_data_combat_all", sep = "/")
...
clusterCols <- c("impute", "seed", "cluster_size", "acc",
...
write.csv(combinedScores, paste0(results_folder, '/missing_data_combat_int.csv'))
